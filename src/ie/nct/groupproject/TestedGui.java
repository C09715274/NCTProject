...
public class TestedGui extends JFrame {
	...
	JPanel contentPane;
	JPanel body;
	JLabel adminPage = new JLabel("Cars Tested");
	...
	private JPanel createBody() {
	    ...
	    scrollPane.setBounds(202, 104, 558, 350);
		...
		JButton btnView = new JButton("View Results");
		btnView.setBackground(new Color(0, 108, 90));
		btnView.setForeground(new Color(244, 235, 58));
		btnView.setBounds(352, 505, 240, 50);
		main.add(btnView);
